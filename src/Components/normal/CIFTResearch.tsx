        ...
        <div className="bg-[#020202] text-slate-100 font-sans overflow-y-scroll snap-y snap-mandatory scroll-smooth custom-scrollbar selection:bg-blue-500/30">
            ...
            <section className="min-h-screen snap-start flex flex-col lg:flex-row bg-[#050505] overflow-hidden relative border-b border-white/5">
                ...
                <div className="w-full lg:w-1/3 p-12 lg:p-16 flex flex-col justify-center bg-zinc-950 border-l border-white/5">
                    ...
                    {/* Major Simulation Card */}
                    <a
                        href="https://your-simulation-website.com"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="mt-12 p-10 bg-gradient-to-br from-blue-950/60 via-cyan-950/50 to-purple-950/60 border-2 border-blue-500/40 rounded-lg hover:border-blue-400 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] transition-all duration-500 group relative overflow-hidden"
                    >
                        {/* Animated Background */}
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="mt-6 pt-6 border-t border-white/10 flex items-center justify-between">
                                <span className="text-xs text-zinc-500 uppercase tracking-wider">Launch Full Simulation</span>
